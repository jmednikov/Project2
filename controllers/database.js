...
var mongoDBURI = 'mongodb://jmednikov:Boom1234.@ds247619.mlab.com:47619/heroku_x8ctph3l'; // mongo url
...
module.exports.storeData = function(req, res) {
  mongodb.MongoClient.connect(mongoDBURI, function(err, client) { // Try to connect to mLab
    ...
    var db = client.db('heroku_x8ctph3l'); // project2 is our mLab database
